...
export const initialData: InitialData = {
  ...
  collections: [
      ...
      filters: [
        {
          ...
          args: {
            facetValueNames: ["Novità"],
            containsAny: false,
          },
        },
      ],
      assetPaths: ["cecenero.jpg"],
    },
    {
      name: "Promozioni",
      slug: "promo",
    ...
    },
    {
      name: "Salumi",
      slug: "salumi",
      parentName: "Categorie",
      filters: [
        {
          code: "facet-value-filter",
          args: {
            facetValueNames: ["Salumi"],
            containsAny: false,
          },
        },
      ],
      assetPaths: ["sarzizza immagine 2.jpg"],
    },
    {
      name: "Olio",
      slug: "olio",
      ...
      filters: [
        {
          code: "facet-value-filter",
          args: {
            facetValueNames: ["Olio"],
            containsAny: false,
          },
        },
      ],
      assetPaths: ["olio 2.jpg"],
    },
    {
      name: "Bio",
      slug: "bio",
      ...
      filters: [
        {
          code: "facet-value-filter",
          args: {
            facetValueNames: ["DermoCosmetica"],
            containsAny: false,
          },
        },
      ],
      assetPaths: ["cosmesi.jpg"],
    },
    {
      name: "Formaggi",
      slug: "formaggi",
      ...
      filters: [
        {
          code: "facet-value-filter",
          args: {
            facetValueNames: ["FORMAGGI"],
            containsAny: false,
          },
        },
      ],
      assetPaths: ["FORMAGGI BIO.jpg"],
    },
    {
      name: "Marmellate Confetture Mostarde",
      slug: "confetture-marmellate-mostarde",
      parentName: "Categorie",
      filters: [
        {
          code: "facet-value-filter",
          args: {
            facetValueNames: ["Marmellate Confetture Mostarde"],
            containsAny: false,
          },
        },
      ],
      assetPaths: ["ricette-marmellate-fatte-in-casa.jpg"],
    },
    {
      name: "Sottaceti sottolio",
      slug: "sottaceti",
      parentName: "Categorie",
      filters: [
        {
          code: "facet-value-filter",
          args: {
            facetValueNames: ["Sottaceti sottolio"],
            containsAny: false,
          },
        },
      ],
      assetPaths: ["sottolio.jpg"],
    },
    {
      name: "Salsa Sughi",
      slug: "salsa-sughi",
      ...
      filters: [
        {
          code: "facet-value-filter",
          args: {
            facetValueNames: ["Salsa Sughi"],
            containsAny: false,
          },
        },
      ],
      assetPaths: ["conserva_pomodoro.jpg"],
    },
    {
      name: "Pasta Prodotti da forno Farina",
      slug: "pasta-prodotti-da-forno-farina",
      parentName: "Categorie",
      filters: [
        {
          code: "facet-value-filter",
          args: {
            facetValueNames: ["Pasta Prodotti da forno Farina"],
            containsAny: false,
          },
        },
      ],
      assetPaths: ["large-italian-homemade-pasta.jpg"],
    },
    {
      name: "Vini Liquori",
      slug: "vini-liquori",
      ...
      filters: [
        {
          code: "facet-value-filter",
          args: {
            facetValueNames: ["Vini Liquori"],
            containsAny: false,
          },
        },
      ],
      assetPaths: ["vino-sicilia 1.jpg"],
    },
    {
      name: "Dolci Miele e Creme",
      slug: "dolci-miele-creme",
      parentName: "Categorie",
      filters: [
        {
          code: "facet-value-filter",
          args: {
            facetValueNames: ["dolci-miele-creme"],
            containsAny: false,
          },
        },
      ],
      assetPaths: ["miele o crema.png"],
    },
    {
      name: "Oli aromatizzati",
      slug: "oli-aromatizzati",
      parentName: "Categorie",
      filters: [
        {
          code: "facet-value-filter",
          args: {
            facetValueNames: ["Oli aromatizzati"],
            containsAny: false,
          },
        },
      ],
      assetPaths: ["Oli-aromatizzati.jpg"],
    },
    {
      name: "Frutta Secca Aromi e Spezie",
      slug: "frutta-secca-aromi-e-spezie",
      parentName: "Categorie",
      filters: [
        {
          code: "facet-value-filter",
          args: {
            facetValueNames: ["Frutta Secca Aromi e Spezie"],
            containsAny: false,
          },
        },
      ],
      assetPaths: ["-SPEZIE-IN-CUCINA-1300x731.jpg"],
    },
    {
      name: "Mini Market",
      slug: "mini-market",
      ...
      filters: [
        {
          code: "facet-value-filter",
          args: {
            facetValueNames: ["Mini Market"],
            containsAny: false,
          },
        },
      ],
      assetPaths: ["Sperlari+interno.jpg"],
    },
    {
      name: "Tartufi e Funghi Porcini",
      slug: "tartufi-funghi-porcini",
      parentName: "Categorie",
      filters: [
        {
          code: "facet-value-filter",
          args: {
            facetValueNames: ["Tartufi e Funghi Porcini"],
            containsAny: false,
          },
        },
      ],
      assetPaths: ["tarufo secondo.png"],
    },
    {
      name: "Pesto e Patè",
      slug: "pesto-pate",
      ...
      filters: [
        {
          code: "facet-value-filter",
          args: {
            facetValueNames: ["Pesto e Patè"],
            containsAny: false,
          },
        },
      ],
      assetPaths: ["pesto.png"],
    },
    {
      name: "Ortaggi e Agrumi",
      slug: "ortaggi-agrumi",
      parentName: "Categorie",
      filters: [
        {
          code: "facet-value-filter",
          args: {
            facetValueNames: ["Ortaggi e Agrumi"],
            containsAny: false,
          },
        },
      ],
